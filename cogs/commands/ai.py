...
class PersonalityModal (discord .ui .Modal ,title ="Set Your AI Personality"):
    def __init__ (self ,ai_cog ,current_personality :str =""):
        ...
        default_prompt ="""You are JagBot, an intelligent and caring Discord bot assistant created by solcodez and hiro.null! 💕
...
Ready to have meaningful conversations and help with anything you need! 💖"""
        ...
        placeholder ="Describe how you want JagBot to respond to you...",
    ...
    async def _get_response (self ,message :str ,history :list ,guild_id :int ,user_id :int =None )->str :
        try :
            ...
            if user_personality :
                ...
                system_context .append ({
                "role":"system",
                "content":"You are a Discord bot with many features including moderation, entertainment, music, games, AI capabilities, and utilities. Support server: https://discord.gg/JZCtSUWf39"
                })
            else :

                system_context .append ({
                "role":"system",
                "content":f"""You are JagBot, an intelligent Discord bot created by solcodez and hiro.null.
...
Support server: https://discord.gg/JZCtSUWf39"""
                })
